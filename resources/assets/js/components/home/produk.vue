      ...
      <div class="produk-modal">
        ...
        <div class="form-produk" id="form-produk">
          <div class="row">
            ...
            <div class="col-md-6">
              <h3>
                <strike style="color: #636363;">Rp {{ this.$store.state.detailproduk.detailProduk.harga_coret | pemisahTitik }}</strike> Rp {{ this.$store.state.detailproduk.detailProduk.harga_jual | pemisahTitik }}
              </h3> 
              <p class="desc">
              ...
              <md-card>
                <div id="card-atas" @click="openModalProduk(produk.id)">
                  <md-card-media class="card-image" >
                    <md-card style="margin-top: -50px!important">
                  ...
                  <md-card-actions class="card-action">
                    <div class="md-toolbar-section-start harga-coret">
                      Rp {{ produk.harga_coret | pemisahTitik }}
                    </div>
                    <div class="md-toolbar-section-end harga-jual">
                      Rp {{ produk.harga_jual | pemisahTitik }}
                    </div>
                  </md-card-actions>
                </div>
                <div id="card-bawah">
            ...
            <div class="md-layout-item">
              <md-card>
                <div id="card-atas" @click="openModalProduk(produk.id)">
                  ...
                  <md-card-actions class="card-action">
                    <div class="md-toolbar-section-start harga-coret">
                      {{ produk.harga_coret | pemisahTitik }}
                    </div>
                    <div class="md-toolbar-section-end harga-jual">
                      {{ produk.harga_jual | pemisahTitik }}
                    </div>
                  </md-card-actions>
                </div>
                <div id="card-bawah">
