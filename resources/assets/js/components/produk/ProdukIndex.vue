            ...
            <div class="md-toolbar" style="margin-top: -20px; padding: 0px">
              ...
              <div class="header-title md-toolbar-section-end">
                <div class="md-layout-item md-medium-size-50 md-small-size-50 md-xsmall-size-100">
                  <md-field md-inline>
                    <label class="media-screen-xsmall-hide" style="font-weight: 400">
                      Cari Berdasarkan...
                    </label>
                    <label class="media-screen-medium-hide" style="font-weight: 400">
                      Cari Produk...
                    </label>
        ...
        <md-card-content>
          ...
          <md-table v-model="searched" md-sort="name" md-sort-order="asc" md-fixed-header>
            ...
            <md-table-row slot="md-table-row" slot-scope="{ item }">
              ...
              <md-table-cell md-label="Nama`" md-sort-by="nama_produk">
                {{ item.nama_produk | capitalize }}
              </md-table-cell>
              <md-table-cell md-label="Harga Coret" md-sort-by="harga_coret">
                {{ item.harga_coret | pemisahTitik }}
              </md-table-cell>
              <md-table-cell md-label="Harga Jual" md-sort-by="harga_jual">
                {{ item.harga_jual | pemisahTitik }}
              </md-table-cell>
