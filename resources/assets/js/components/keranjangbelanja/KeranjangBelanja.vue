      ...
      <md-card md-with-hover>
	    ...
	    <div class="row">
                ...
                <md-progress-spinner md-mode="indeterminate"></md-progress-spinner>
	            	...
	            	<td class="product-price" data-title="Harga" style="text-align:right">
	            		<span class="woocommerce-Price-amount amount">
	            			...
	            			<b>{{ keranjangbelanja.harga_produk | pemisahTitik }}</b>
	            		</span>
		        		</td>
               	<td class="product-quantity" data-title="Jumlah" style="text-align:right">
             	   	<div class="quantity buttons_added">
             	   		<button class="btn btn-md" @click="kurangJumlahKeranjang(keranjangbelanja.id_keranjang_belanja,keranjangbelanja.harga_produk)" style="background-color:#da2921;color:white;">&nbsp;( - )</button>
							    	<span class="woocommerce-Price-amount amount">
							    		...
							    		<b>{{ keranjangbelanja.jumlah_produk | pemisahTitik }}</b>
							    	</span>
           		 	...
           		 	<td class="product-subtotal" data-title="Subtotal" style="text-align:right">
             	 		<span class="woocommerce-Price-amount amount">
             	 			<span class="woocommerce-Price-currencySymbol">Rp </span>
             	 			<b>{{ keranjangbelanja.subtotal | pemisahTitik }}</b>
             	 		</span>
             		</td>
            	</tr>
            </tbody>
            <tbody class="data-tidak-ada" v-else>
             	<tr>
             		<td colspan="6" class="text-center">Tidak Ada Data Keranjang Belanja</td>
             	</tr>
            </tbody>
					</table>
					<md-button :to="`/list-produk`" style="align:right;" class="md-dense md-raised md-primary">
						Lanjut Belanja<md-icon>undo</md-icon>
					</md-button>
				</div>
				<div class="col-md-3">
		        ...
		        <tbody>
		          ...
		          <tr>
		            ...
		            <td style="text-align:right">
		            	<span class="woocommerce-Price-amount amount">
		            		<span class="woocommerce-Price-currencySymbol">Rp </span>
		            		<b>{{ this.$store.state.keranjangbelanja.total_akhir | pemisahTitik }}</b>
		            	</span>
		            </td>    
		          </tr>
		        </tbody>
		      </table>
				  <md-button :to="`/checkout`" v-if="this.$store.state.keranjangbelanja.countKeranjang > 0"  style="align:right;" class="md-dense md-raised md-accent">
				  	Proses Checkout  <md-icon>send</md-icon>
				  </md-button>
				</div>
			 	<div class="col-md-1"></div>
