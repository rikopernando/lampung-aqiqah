                    ...
                    <td class="wrapper">
                        <table border="0" cellpadding="0" cellspacing="0">
                         <tr>
							...
							<p>Pesanan Anda dengan nomor <b>Order # {{$pesanan->id}}</b> telah diselesaikan pada tanggal <b>{{$pesanan->tanggal_dikonfirmasi}}</b></p>
                            <p>Terima Kasih telah berbelanja di Aqiqah Lampung. <br>
                            Kami nantikan kunjungan berikutnya. </p>
