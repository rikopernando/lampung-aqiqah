                    ...
                    <td class="wrapper">
                        <table border="0" cellpadding="0" cellspacing="0">
                         <tr>
							...
							<p>Pesanan Anda dengan nomor <b>Order # {{$pesanan->id}}</b> sudah kami konfirmasi pada tanggal <b>{{$pesanan->tanggal_dikonfirmasi}}</b>, dan akan kami proses lebih lanjut sampai dengan selesai.</p>
