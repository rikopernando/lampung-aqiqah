                ...
                <table class="main">
                    ...
                    <td class="wrapper">
                        <table border="0" cellpadding="0" cellspacing="0">
                         <tr>
                            <td>
                            <p>Hi {{ $pesanan->pelanggan->name }}</p>
							<p>Terima kasih atas kepercayaan anda kepada kami. <br> Pesanan anda dengan nomor <b>Order # {{$pesanan->id}}</b> sudah berhasil dilakukan & sudah kami terima pada tanggal <b>{{$pesanan->Tanggal}}</b> dengan metode pembayaran <b>{{$pesanan->metode_pembayaran}}</b>.</p>
                                                  ...
                                                  <tr>
                                                    <td>
                                                      <div class="img-container"  style="padding-left: 5px; padding-top: 1px; padding-bottom: 1px; padding-right: 1px; width:75px;">
                                                        @if(empty($detail_pesanans->produk->foto))
                                                            <img src="{{url('image_produks/default.jpg')}}">
                                                        @else
                                                            <img src="{{url('image_produks/'.$detail_pesanans->produk->foto)}}">
                                                        @endif
                                                      </div>
                                                    </td>
                                                    <td> {{title_case($detail_pesanans->produk->nama_produk)}} <br> 
                                                      Quantity : {{ number_format($detail_pesanans->jumlah_produk, 0, ',', '.')}}<br>
                                                      Harga : {{number_format($detail_pesanans->harga_produk, 0, ',', '.')}}<br>
                                                    </td>
                                                    <td align="right">
                                                        <b align="right">Rp. {{ number_format($detail_pesanans->subtotal ,0, ',', '.')}}</b>
                                                    </td>
                                                  </tr>
                                                  @endforeach
                                                </tbody>
